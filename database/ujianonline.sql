...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2023 at 03:16 AM
...
(107, 7, '<p><br></p>', 'uploads/soal_psikotest10.png', 'asdad'),
(108, 6, '<p>ascac</p>', 'uploads/mbti_saya3.png', 'accsacasc');
...
--
ALTER TABLE `tb_jawaban_essay`
  MODIFY `id_jawaban_essay` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_peserta_essay`
  MODIFY `id_peserta_essay` int(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_soal_essay`
  MODIFY `id_soal_essay` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
