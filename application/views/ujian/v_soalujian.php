...
<section class="content">
    <div class="row">
        <div class="col-md-3" style="background-color: #f5f5f5; border: 1px solid #ddd;">
            <div class="box box-success" style="border-radius: 5px; box-shadow: 0px 0px 5px #888;">
                <div class="box-header text-center" style="background-color: #28a745; color: #fff; padding: 10px;">
                ...
                <div class="box-footer" style="background-color: #28a745; height: 10px;"></div>
            </div>
        </div>
        <div class="col-md-9">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $s->pertanyaan; ?>
                                                    ...
                                                    <br>
                                                    <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="A" required /> <?php echo $s->a; ?>
                                                    <br>
                                                    <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="B" required /> <?php echo $s->b; ?>
                                                    <br>
                                                    <input type="radio" name="jawaban[<?php echo $s->id_soal_ujian; ?>]" value="C" required /> <?php echo $s->c; ?>
                                                    <br>
