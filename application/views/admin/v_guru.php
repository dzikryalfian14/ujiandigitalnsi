    ...
    <div class="col-md-12">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          <center>
            <h4 class="box-title">Data Penguji</h4>
          </center>
          <p>
      ...
      <form method="post" action="<?php echo base_url() . 'guru/guru_aksi'; ?>">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Penguji" required="">
          </div>
          <div class="form-group">
            <label class="font-weight-bold">NIK (Nomor Induk Kepegawaian)</label>
            <input type="number" class="form-control" name="nik" placeholder="Masukkan NIK Penguji" required="">
          </div>
          <div class="form-group">
