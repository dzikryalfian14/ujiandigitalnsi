        ...
        <div class="box box-success">
          ...
          <form class="form-horizontal" action="<?= base_url('peserta/update'); ?>" method="post">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Ujian Jenis Ujian</label>

                <div class="col-sm-10">
                  <select class="select2 form-control" name="mapel" required value="">
                    <option selected="selected" disabled="">- Pilih Mata Jenis Ujian -</option>
                    <?php foreach ($mapel as $a) { ?>
                      <option value="<?= $a->id_matapelajaran ?>" <?php if ($p->nama_matapelajaran == $a->nama_matapelajaran) {
                                                                    echo "selected='selected'";
