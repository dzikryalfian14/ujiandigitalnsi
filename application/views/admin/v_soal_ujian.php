        ...
        <div class="col-md-12">
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <div class="box-header">
                    ...
                    <a href="<?php echo base_url('matapelajaran'); ?>"><button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#"><span></span>Data Nama Ujian</button></a>
                </div>
