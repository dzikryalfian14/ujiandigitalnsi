    ...
    <div class="col-md-12">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header">
          <center>
            <h3 class="box-title">Data Nama Ujian</h3>
          </center>
          <p>
      ...
      <form method="post" action="<?php echo base_url() . 'matapelajaran/mapel_aksi'; ?>">
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="kode" placeholder="Masukkan Kode Nama Ujian" required="">
          </div>
          <div class="form-group">
            <label class="font-weight-bold">Nama Ujian</label>
            <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Ujian" required="">
          </div>
        </div>
