    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="box box-success" style="overflow-x: scroll;">
                <form class="form-horizontal" action="<?= base_url('peserta_essay_tambah/insert_'); ?>" method="post">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">Nama Ujian</label>
                            <div class="col-sm-10">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="jenis_ujian" required>
                                    ...
                                    <?php foreach ($jenis_ujian_essay as $a) { ?>
                                        <option value="<?= $a->id_jenis_ujian_essay ?>"><?= $a->jenis_ujian_essay; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
