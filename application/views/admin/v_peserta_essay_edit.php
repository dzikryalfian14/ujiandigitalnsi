...
<section class="content">
    <div class="row">
        ...
        <?php foreach ($peserta_essay as $p) { ?>
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="<?= base_url('peserta_essay/update'); ?>" method="post">
                        <div class="box-body">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nama peserta</label>
                                <input type="hidden" name="id" value="<?= $p->id_peserta_essay ?>">
                                <div class="col-sm-10">
                                    <select class="select2 form-control" name="peserta" required>
                                        ...
                                        <?php foreach ($siswa as $a) { ?>
                                            <option value="<?= $a->id_siswa ?>" <?php if ($a->nama_siswa == $p->nama_siswa) {
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-control" name="mapel" required value="">
                                        ...
                                        <?php foreach ($mapel_essay as $a) { ?>
                                            <option value="<?= $a->id_mapel_essay ?>" <?php if ($p->nama_mapel_essay == $a->nama_mapel_essay) {
                                                                                            echo "selected='selected'";
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="select2 form-control" name="jenis" required value="">
                                        ...
                                        <?php foreach ($jenis_ujian_essay as $a) { ?>
                                            <option value="<?= $a->id_jenis_ujian_essay ?>" <?php if ($p->jenis_ujian_essay == $a->jenis_ujian_essay) {
                                                                                                echo "selected='selected'";
                                                                                            } ?>><?= $a->jenis_ujian_essay; ?>
                                            </option>
                                        <?php } ?>
