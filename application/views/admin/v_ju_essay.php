        ...
        <div class="col-md-12">
            ...
            <div class="box box-success" style="overflow-x: scroll;">
                <div class="box-header">
                    ...
                    <a href="<?= base_url('peserta_essay') ?>" class="btn btn-default btn-flat"><span class="fa fa-arrow-left"></span> Kembali</a>
                    <?php echo '<button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal-data" onclick="$(\'#modal-data-body\').load(\'' . base_url('jenis_ujian_essay/create') . '\')"><span class="fa fa-plus"></span> Jenis Ujian</button>' ?>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    <table id="data" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($jenis_ujian_essay as $m) { ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $m->jenis_ujian_essay; ?></td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                <li><a href="<?= base_url('jenis_ujian_essay/edit/') . $m->id_jenis_ujian_essay; ?>">Edit Data</a></li>
                                                <li><a href="<?= base_url('jenis_ujian_essay/hapus/') . $m->id_jenis_ujian_essay; ?>" onclick="return confirm('Apakah yakin data peserta ini di hapus?')">Hapus Data</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
            ...
            <form action="<?= base_url('siswa/import'); ?>" method="post" class="form-horizontal">
                <div class="box-body">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <a href="<?= base_url('format/format-import-data-siswa.xlsx') ?>" class="pull-right" download><i class="fa fa-download"></i> Download Format Data Import Peserta</a>
                        </div>
                    </div>
                    <div class="form-group">
